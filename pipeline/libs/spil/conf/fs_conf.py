...
path_templates = OrderedDict([
    ...
    ('asset_file',
     r'{@project_root}/03_WORK_PIPE/01_ASSET_3D/{cat}/{name}/3d/scenes/{task}/{subtask}/{state}_{version}/{name}.{ext}'),

    ('asset_image_file',
     r'{@project_root}/03_WORK_PIPE/01_ASSET_3D/{cat}/{name}/3d/images/{task}/{subtask}/{state}_{version}/{name}.{frames}.{ext}'),
    ('asset_movie_file',
     r'{@project_root}/03_WORK_PIPE/01_ASSET_3D/{cat}/{name}/3d/images/{task}/{subtask}/{state}_{version}/{name}.{ext}'),

    ('asset_cache_file',
     r'{@project_root}/03_WORK_PIPE/01_ASSET_3D/{cat}/{name}/3d/caches/{task}/{subtask}/{state}_{version}'),

    ('asset_state',
     r'{@project_root}/03_WORK_PIPE/01_ASSET_3D/{cat}/{name}/3d/scenes/{task}/{subtask}/{state}_{version}'),
    ('asset_subtask',
     r'{@project_root}/03_WORK_PIPE/01_ASSET_3D/{cat}/{name}/3d/scenes/{task}/{subtask}'),
    ('asset_task',
     r'{@project_root}/03_WORK_PIPE/01_ASSET_3D/{cat}/{name}/3d/scenes/{task}'),
    ...
    ('shot_cache_file',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/caches/{seq}/{shot}/{task}/{subtask}/{state}_{version}'),

    ('shot_image_file',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/images/{seq}/{shot}/{task}/{subtask}/{state}_{version}/{seq}_{shot}.{frames}.{ext}'),
    ('shot_movie_file',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/images/{seq}/{shot}/{task}/{subtask}/{state}_{version}/{seq}_{shot}.{ext}'),

    ('shot_state',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/scenes/{seq}/{shot}/{task}/{subtask}/{state}_{version}'),
    ('shot_subtask',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/scenes/{seq}/{shot}/{task}/{subtask}'),
    ('shot_task',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/scenes/{seq}/{shot}/{task}'),
    ('shot_shot',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/scenes/{seq}/{shot}'),
    ('shot_seq', r'{@project_root}/03_WORK_PIPE/02_SHOT/3d/scenes/{seq}'),

    ('shot_2d_file',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/2d/scenes/{seq}/{shot}/{task}/{subtask}/{state}_{version}/{seq}_{shot}.{ext}'),

    ('shot_2d_image_file',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/2d/images/{seq}/{shot}/{task}/{subtask}/{state}_{version}/{seq}_{shot}.{frames}.{ext}'),
    ('shot_2d_movie_file',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/2d/images/{seq}/{shot}/{task}/{subtask}/{state}_{version}/{seq}_{shot}.{ext}'),

    ('shot_2d_state',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/2d/scenes/{seq}/{shot}/{task}/{subtask}/{state}_{version}'),
    ('shot_2d_subtask',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/2d/scenes/{seq}/{shot}/{task}/{subtask}'),
    ('shot_2d_task',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/2d/scenes/{seq}/{shot}/{task}'),
    ('shot_2d_shot',
     r'{@project_root}/03_WORK_PIPE/02_SHOT/2d/scenes/{seq}/{shot}'),
