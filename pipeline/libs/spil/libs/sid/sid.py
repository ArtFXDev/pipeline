...
class BaseSid(object):
    ...
    @property
    def keys(self): #looks to be a list of attribute ? where are they defined ?
        return self._keys
    ...
    def get_filled(self, by, until=None):
        """
...
if __name__ == '__main__':
    ...
    test = Sid('demo/a/')
    print 'test', test
    print 'test', test.get_with(ext='bla')
    print 'filled', test.get_filled(by='*')
    print 'filled until shot', test.get_filled(by='*', until='name')
